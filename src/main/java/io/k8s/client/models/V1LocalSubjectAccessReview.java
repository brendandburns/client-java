...
public class V1LocalSubjectAccessReview {
     ...
     * @return the V1LocalSubjectAccessReview object itself.
     */
    public V1LocalSubjectAccessReview withApiVersion(String apiVersion) {
     ...
     * @return the V1LocalSubjectAccessReview object itself.
     */
    public V1LocalSubjectAccessReview withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1LocalSubjectAccessReview object itself.
     */
    public V1LocalSubjectAccessReview withMetadata(V1ObjectMeta metadata) {
     ...
     */
    public V1SubjectAccessReviewSpec spec() {
        return this.spec;
    }
     ...
     * @return the V1LocalSubjectAccessReview object itself.
     */
    public V1LocalSubjectAccessReview withSpec(V1SubjectAccessReviewSpec spec) {
        this.spec = spec;
        return this;
    }
     ...
     * @return the V1LocalSubjectAccessReview object itself.
     */
    public V1LocalSubjectAccessReview withStatus(V1SubjectAccessReviewStatus status) {
        this.status = status;
        return this;
    }
