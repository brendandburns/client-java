...
public class V1beta1StorageClass {
     ...
     * @return the V1beta1StorageClass object itself.
     */
    public V1beta1StorageClass withApiVersion(String apiVersion) {
     ...
     * @return the V1beta1StorageClass object itself.
     */
    public V1beta1StorageClass withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1beta1StorageClass object itself.
     */
    public V1beta1StorageClass withMetadata(V1ObjectMeta metadata) {
     ...
     * @return the V1beta1StorageClass object itself.
     */
    public V1beta1StorageClass withParameters(Map<String, String> parameters) {
     ...
     * @return the V1beta1StorageClass object itself.
     */
    public V1beta1StorageClass withProvisioner(String provisioner) {
