...
public class V1PersistentVolumeClaim {
     ...
     * @return the V1PersistentVolumeClaim object itself.
     */
    public V1PersistentVolumeClaim withApiVersion(String apiVersion) {
     ...
     * @return the V1PersistentVolumeClaim object itself.
     */
    public V1PersistentVolumeClaim withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1PersistentVolumeClaim object itself.
     */
    public V1PersistentVolumeClaim withMetadata(V1ObjectMeta metadata) {
     ...
     */
    public V1PersistentVolumeClaimSpec spec() {
        return this.spec;
    }
     ...
     * @return the V1PersistentVolumeClaim object itself.
     */
    public V1PersistentVolumeClaim withSpec(V1PersistentVolumeClaimSpec spec) {
        this.spec = spec;
        return this;
    }
     ...
     */
    public V1PersistentVolumeClaimStatus status() {
        return this.status;
    }
     ...
     * @return the V1PersistentVolumeClaim object itself.
     */
    public V1PersistentVolumeClaim withStatus(V1PersistentVolumeClaimStatus status) {
        this.status = status;
        return this;
    }
