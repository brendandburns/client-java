...
public class Appsv1beta1DeploymentSpec {
     ...
     * be estimated during the time a deployment is paused. Defaults to 600s.
     */
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withMinReadySeconds(Integer minReadySeconds) {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withPaused(Boolean paused) {
        this.paused = paused;
        return this;
    }
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withProgressDeadlineSeconds(Integer progressDeadlineSeconds) {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withReplicas(Integer replicas) {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withRevisionHistoryLimit(Integer revisionHistoryLimit) {
     ...
     */
    public Appsv1beta1RollbackConfig rollbackTo() {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withRollbackTo(Appsv1beta1RollbackConfig rollbackTo) {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withSelector(V1LabelSelector selector) {
     ...
     */
    public Appsv1beta1DeploymentStrategy strategy() {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withStrategy(Appsv1beta1DeploymentStrategy strategy) {
     ...
     * @return the Appsv1beta1DeploymentSpec object itself.
     */
    public Appsv1beta1DeploymentSpec withTemplate(V1PodTemplateSpec template) {
