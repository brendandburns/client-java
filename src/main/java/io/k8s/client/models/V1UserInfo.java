...
public class V1UserInfo {
     ...
     * @return the V1UserInfo object itself.
     */
    public V1UserInfo withExtra(Map<String, List<String>> extra) {
        this.extra = extra;
        return this;
    }
     ...
     * @return the V1UserInfo object itself.
     */
    public V1UserInfo withGroups(List<String> groups) {
        this.groups = groups;
        return this;
    }
     ...
     * @return the V1UserInfo object itself.
     */
    public V1UserInfo withUid(String uid) {
        this.uid = uid;
        return this;
    }
     ...
     * @return the V1UserInfo object itself.
     */
    public V1UserInfo withUsername(String username) {
