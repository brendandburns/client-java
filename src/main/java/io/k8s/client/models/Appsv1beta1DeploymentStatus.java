...
public class Appsv1beta1DeploymentStatus {
    ...
    private List<Appsv1beta1DeploymentCondition> conditions;
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withAvailableReplicas(Integer availableReplicas) {
     ...
     */
    public List<Appsv1beta1DeploymentCondition> conditions() {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withConditions(List<Appsv1beta1DeploymentCondition> conditions) {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withObservedGeneration(Long observedGeneration) {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withReadyReplicas(Integer readyReplicas) {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withReplicas(Integer replicas) {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withUnavailableReplicas(Integer unavailableReplicas) {
     ...
     * @return the Appsv1beta1DeploymentStatus object itself.
     */
    public Appsv1beta1DeploymentStatus withUpdatedReplicas(Integer updatedReplicas) {
