...
public class V1alpha1Role {
     ...
     * @return the V1alpha1Role object itself.
     */
    public V1alpha1Role withApiVersion(String apiVersion) {
     ...
     * @return the V1alpha1Role object itself.
     */
    public V1alpha1Role withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1alpha1Role object itself.
     */
    public V1alpha1Role withMetadata(V1ObjectMeta metadata) {
     ...
     * @return the V1alpha1Role object itself.
     */
    public V1alpha1Role withRules(List<V1alpha1PolicyRule> rules) {
        this.rules = rules;
        return this;
    }
