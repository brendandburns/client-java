...
public class Extensionsv1beta1ScaleStatus {
     ...
     * @return the Extensionsv1beta1ScaleStatus object itself.
     */
    public Extensionsv1beta1ScaleStatus withReplicas(int replicas) {
     ...
     * @return the Extensionsv1beta1ScaleStatus object itself.
     */
    public Extensionsv1beta1ScaleStatus withSelector(Map<String, String> selector) {
     ...
     * @return the Extensionsv1beta1ScaleStatus object itself.
     */
    public Extensionsv1beta1ScaleStatus withTargetSelector(String targetSelector) {
