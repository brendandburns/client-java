...
public class V1alpha1ClusterRoleBinding {
    ...
    private List<V1alpha1Subject> subjects;
     ...
     * @return the V1alpha1ClusterRoleBinding object itself.
     */
    public V1alpha1ClusterRoleBinding withApiVersion(String apiVersion) {
     ...
     * @return the V1alpha1ClusterRoleBinding object itself.
     */
    public V1alpha1ClusterRoleBinding withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1alpha1ClusterRoleBinding object itself.
     */
    public V1alpha1ClusterRoleBinding withMetadata(V1ObjectMeta metadata) {
     ...
     */
    public V1alpha1RoleRef roleRef() {
        return this.roleRef;
    }
     ...
     * @return the V1alpha1ClusterRoleBinding object itself.
     */
    public V1alpha1ClusterRoleBinding withRoleRef(V1alpha1RoleRef roleRef) {
     ...
     */
    public List<V1alpha1Subject> subjects() {
     ...
     * @return the V1alpha1ClusterRoleBinding object itself.
     */
    public V1alpha1ClusterRoleBinding withSubjects(List<V1alpha1Subject> subjects) {
