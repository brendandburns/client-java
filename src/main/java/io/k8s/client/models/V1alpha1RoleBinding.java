...
public class V1alpha1RoleBinding {
     ...
     * @return the V1alpha1RoleBinding object itself.
     */
    public V1alpha1RoleBinding withApiVersion(String apiVersion) {
     ...
     * @return the V1alpha1RoleBinding object itself.
     */
    public V1alpha1RoleBinding withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1alpha1RoleBinding object itself.
     */
    public V1alpha1RoleBinding withMetadata(V1ObjectMeta metadata) {
     ...
     * @return the V1alpha1RoleBinding object itself.
     */
    public V1alpha1RoleBinding withRoleRef(V1alpha1RoleRef roleRef) {
     ...
     * @return the V1alpha1RoleBinding object itself.
     */
    public V1alpha1RoleBinding withSubjects(List<V1alpha1Subject> subjects) {
