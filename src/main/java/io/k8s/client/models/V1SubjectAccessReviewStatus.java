...
public class V1SubjectAccessReviewStatus {
     ...
     * @return the V1SubjectAccessReviewStatus object itself.
     */
    public V1SubjectAccessReviewStatus withAllowed(boolean allowed) {
     ...
     * @return the V1SubjectAccessReviewStatus object itself.
     */
    public V1SubjectAccessReviewStatus withEvaluationError(String evaluationError) {
     ...
     * @return the V1SubjectAccessReviewStatus object itself.
     */
    public V1SubjectAccessReviewStatus withReason(String reason) {
        this.reason = reason;
        return this;
    }
