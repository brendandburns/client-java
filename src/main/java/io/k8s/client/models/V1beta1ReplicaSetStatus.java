...
public class V1beta1ReplicaSetStatus {
    ...
    private List<V1beta1ReplicaSetCondition> conditions;
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withAvailableReplicas(Integer availableReplicas) {
     ...
     */
    public List<V1beta1ReplicaSetCondition> conditions() {
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withConditions(List<V1beta1ReplicaSetCondition> conditions) {
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withFullyLabeledReplicas(Integer fullyLabeledReplicas) {
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withObservedGeneration(Long observedGeneration) {
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withReadyReplicas(Integer readyReplicas) {
     ...
     * @return the V1beta1ReplicaSetStatus object itself.
     */
    public V1beta1ReplicaSetStatus withReplicas(int replicas) {
