...
public class V1beta1LocalSubjectAccessReview {
     ...
     * @return the V1beta1LocalSubjectAccessReview object itself.
     */
    public V1beta1LocalSubjectAccessReview withApiVersion(String apiVersion) {
     ...
     * @return the V1beta1LocalSubjectAccessReview object itself.
     */
    public V1beta1LocalSubjectAccessReview withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the V1beta1LocalSubjectAccessReview object itself.
     */
    public V1beta1LocalSubjectAccessReview withMetadata(V1ObjectMeta metadata) {
     ...
     * @return the V1beta1LocalSubjectAccessReview object itself.
     */
    public V1beta1LocalSubjectAccessReview withSpec(V1beta1SubjectAccessReviewSpec spec) {
        this.spec = spec;
        return this;
    }
     ...
     * @return the V1beta1LocalSubjectAccessReview object itself.
     */
    public V1beta1LocalSubjectAccessReview withStatus(V1beta1SubjectAccessReviewStatus status) {
        this.status = status;
        return this;
    }
